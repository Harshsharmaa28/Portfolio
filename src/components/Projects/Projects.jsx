  ...
  return (
    <div className=' overflow-hidden h-screen'>
      ...
      <div className='vsm:max-sm:flex-col flex ' >
        ...
        <div className='md:hidden mx-4 vsm:max-sm:h-screen bg-white flex justify-center items-center'>
          <motion.img
            className='md:hidden rounded-md shadow-xl w-[37rem] h-[100%]' src={nexlearn} alt="" />
        </div>
      </div>
    </div>
  )
