...
const Projects = () => {
  ...
  return (
    <div className=' overflow-x-hidden h-screen'>
      <h1 className='mx-4  lg:mx-32 text-3xl font-semibold text-accent md:py-14 vsm:max-sm:mt-10 py-6'>My Projects</h1>
      <div className='vsm:max-sm:flex-col flex ' >
        <div className=''>
          ...
          <div className=' mx-4 vsm:max-sm:py-5  lg:mx-32 flex  gap-5 items-center'>
        ...
        <div className='vsm:max-md:hidden vsm:max-sm:h-[20rem] flex justify-center items-center'>
          <motion.img
            initial={{ x: 120, y: -150 }}
            whileInView={{ x: 0, y: 0 }}
            transition={{
