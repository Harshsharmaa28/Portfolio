        ...
        <div className=' mx-32 flex flex-col'>
            <div className=' relative py-6'>
                <div className=' relative w-auto'>
                    <h1 onMouseEnter={() => setClick(true)} onMouseLeave={() => setClick(false)} className='hover:cursor-pointer hover:opacity-100 opacity-75 font text-accent font-semibold text-6xl'>{title}</h1>
                    {clicked &&
                        <motion.div
                            ...
                            className={` w-[50%] overflow-hidden h-[4px] bg-accent `}
                            whileHover={{ width: "" }} />
                    }
