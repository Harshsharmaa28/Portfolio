...
const Contact = () => {
  ...
  return (
    <div className={` ${!theme ? '  bg-black' : ''} overflow-hidden vsm:max-sm: md:h-screen `}>
      <div className=' mx-4 lg:mx-32 h-[20rem] md:h-[30rem] bg-accent mt-20 rounded-3xl flex justify-center'>
        <div className=' flex flex-col gap-14 md:gap-20 justify-center items-center'>
          ...
          >Get In Touch</div>
          <span className='vsm:max-sm:text-xl sm:max-md:text-3xl text-white text-5xl xl:text-7xl'>{email}</span>
          <button
