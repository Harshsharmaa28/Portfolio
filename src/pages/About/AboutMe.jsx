...
const AboutMe = () => {
    ...
    return (
        <div className='vsm:max-sm:flex-col md:mx-32 flex'>
            <div className='vsm:max-sm:flex vsm:max-sm:justify-center '>
                <img data-aos="fade-up" data-aos-duration="1000"  className='md:w-[30rem] md:h-[30rem] bg-blue-100' src="" alt="" />
            </div>
